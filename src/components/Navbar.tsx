            ...
            <div className="hidden md:flex items-center gap-2">
              {user ? (
                ...
                <>
                  ...
                  {/* <button
                    className="ml-3 px-3 py-1 rounded bg-transparent border border-gray-300 hover:bg-gray-100 text-sm"
            ...
            <div className="space-y-2">
              {user ? (
                ...
                <>
                  ...
                  {/* <button
                    onClick={() => setShowLogin(true)}
                    className="w-full bg-transparent border border-gray-300 text-sm px-4 py-2 rounded-full hover:bg-gray-100"
                  >
                    Login
                  </button> */}
                </>
